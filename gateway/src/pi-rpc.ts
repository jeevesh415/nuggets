...
export class PiRpc extends EventEmitter {
  ...
  private send(obj: Record<string, unknown>): void {
    ...
    log.info({ id: obj.id, type: obj.type, message: obj.message }, "Sending to Pi");
  ...
  private onLine(line: string): void {
    ...
    log.info({ type: event.type, id: event.id, hasCmd: !!event.command, success: event.success }, "Pi event");
